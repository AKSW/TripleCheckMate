...
public class EvaluationItemDialog extends DialogBox {
	...
	@UiField HTML htmlTripleS;
	@UiField HTML htmlTripleP;
	@UiField HTML htmlTripleO;

	@UiField Tree treeError;
	@UiField HTML htmlExampleURI;
	@UiField HTML htmlExampleN3;
	@UiField HTML htmlExampleDesc;
